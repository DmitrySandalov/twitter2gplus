<?php
/*
Google+ (plus.google.com) PHP Curl bot by http://360percents.com
Created on: Sep 29 2011 - Updated on Oct 25 2011
See: http://360percents.com/
...
#OPTIONAL PARAMETERS
$cookies = 'cookie.txt';
$sleeptime = 0; //optional timeout (look less suspicious to Google)
...
function login_data()
{
	...
	$buf = utf8_decode(html_entity_decode(curl_exec($ch))); //execute the curl command
	curl_close($ch);
	...
	//returns array(postdata,postaction)
